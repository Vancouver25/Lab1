...
%2   generate random initial values of w1, w2 and b
w1 = randn(1);
w2 = randn(1);
b = randn(1);

%3   calculate weighted sum with randomly generated parameters
v1 = x1(1)*w1 + x2(1)*w2 + b;
%4   calculate current output of the perceptron 
if v1 > 0
	y = 1;
else
	y = -1;
...
%5  calculate the total error for these 5 inputs 
e = abs(e1) + abs(e2) + abs(e3) + abs(e4) + abs(e5);

%3 - 6    write training algorithm
  n = 0.15;
...
% 
%6   update parameters using current inputs ant current error
